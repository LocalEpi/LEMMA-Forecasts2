GetCountyData <- function() {
  ...
  holiday_set <- as.Date(c("2021/11/25", "2021/11/26", "2021/12/24", "2021/12/25", "2021/12/31", "2022/1/1", "2022/1/17", "2022/2/21",  "2022/5/30", "2022/6/20", "2022/7/4", "2022/9/5", "2022/11/11", "2022/11/25", "2022/11/26", "2022/12/24", "2022/12/25",  "2022/12/26", "2023/1/1", "2023/1/2"))
  cases[date %in% holiday_set, cases.conf := NA_real_]
